...
📱 **WhatsApp Broadcast:**
"🚨 Hey warriors! We've just dropped the ultimate guide for ${title}. Don't miss out on this crucial update for ${channel} 🚀 Link below 👇"

🐦 **Twitter / X:**
"Cracking the exam code! 🧬 Just published our new insights on ${title}. Are you ready? Drop your doubts below. #IISER #NISER"

📸 **Instagram Caption:**
"The wait is over! 🔥 Dive deep into ${title}.
We cover everything you need to know to secure your dream institute.
Link in bio! 🔗
.
.
#futuredoctors #futurescientists #IISc"
`;
